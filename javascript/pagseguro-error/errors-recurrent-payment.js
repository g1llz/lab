module.exports = {
  ...
  11002: 'receiverEmail tamanho inválido: {0}',
  11006: 'redirectURL tamanho inválido: {0}',
  11007: 'redirectURL valor inválido: {0}',
  11008: 'reference tamanho inválido: {0}',
  ...
  11040: 'maxAge formato inválido: {0}. Deve ser um inteiro',
  11041: 'maxAge fora do intervalo: {0}',
  11042: 'maxUses formato inválido: {0}. Deve ser um inteiro',
  11043: 'maxUses fora do intervalo: {0}',
  11054: 'abandonURL/reviewURL tamanho inválido: {0}',
  11055: 'abandonURL/reviewURL valor inválido: {0}',
  ...
  17008: 'Assinatura não encontrado',
  17022: 'Status da assinatura é inválido para executar essa operação. O status atual é {0}',
  17023: 'O vendedor não tem opção de pagamento com cartão de crédito',
  17024: 'Assinatura não é permitida para este vendedor {0}',
  17032: 'Receptor inválido para pagamento: {0} verificar o status da conta do destinatário e se é uma conta do vendedor.',
  17033: 'preApproval.paymentMethod não é {0}. Ele deve ser o mesmo da assinatura',
  ...
  17082: 'Status de pedido de pagamento da assinatura é inválido para executar a operação solicitada. O status é {0}',
  17083: 'Assinatura já está {0}',
  17093: 'O hash ou IP do remetente é obrigatório',
  17094: 'Não pode haver novas assinaturas para um plano inativo',
  19001: 'CEP inválido: {0}',
  19002: 'Rua tem tamanho inválido: {0}',
  19003: 'Número tem tamanho inválido: {0}',
  19004: 'Complemento tem tamanho inválido: {0}',
  19005: 'Bairro tem tamanho inválido: {0}',
  19006: 'Cidade tem tamanho inválido: {0}',
  19007: 'Estado tem valor inválido: {0}. (ex: SP)',
  19008: 'País tem tamanho inválido: {0}. (ex: BRA)',
  19014: 'Telefone tem valor inválido: {0}',
  19015: 'País tem valor inválido: {0}. (ex: BRA)',
  ...
  53048: 'Data de aniversário de titular do cartão é inválido: {0}',
  ...
  61008: 'Tipo de documento é inválido: {0}',
  61009: 'Valor do documento é obrigatório',
  61010: 'Valor do documento é inválido: {0}',
